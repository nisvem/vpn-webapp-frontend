...
var require_convert = __commonJS({
  "node_modules/convert-pro/convert.js"(exports) {
    "use strict";
    ...
    exports.length = [
      ...
      ["Millimeter", "Millimeters", "MM", 1e-3],
      ["Centimeter", "Centimeters", "CM", 0.01],
      ["Meter", "Meters", "M", 1],
      ["Kilometer", "Kilometers", "KM", 1e3],
      ...
      ["Parsec", "Parsecs", "PC", 30856775814913670]
    ];
    exports.area = __spreadArrays(higherDim(exports.length, 2), [
      ["Acre", "Acres", "Ac", 4046.86],
      ["Deciare", "Deciares", "Da", 10],
      ["Are", "Ares", "Are", 100],
      ["Decare", "Decares", "Decare", 1e3]
    ]);
    exports.volume = __spreadArrays(higherDim(exports.length, 3), [
      ["Liter", "Liters", "L", 1e-3],
      ["MilliLiter", "MilliLiter", "ML", 1e-6],
      ["Fluid Once", "Fluid Once", "fl-oz", 2841312686461145e-20],
      ["Table Spoon", "Table Spoons", "tbsp", 17758204290382156e-21],
      ["Tea Spoon", "Tea Spoons", "tsp", 5919401430127385e-21]
    ]);
    exports.time = [
    ...
    exports.energy = [
      ["Joule", "Joules", "J", 1, 1],
      ["Kilojoule", "Kilojoules", "KJ", 1e3],
      ["Calorie", "Calories", "Cal", 4.184, 1],
      ["Kilocalorie", "Kilocalories", "KCal", 4184],
      ["Watt-hour", "Watt-hour", "Wh", 3600, 1],
      ["KiloWatthour", "KiloWatthour", "kWh", 36e5],
      ["Electronvolt", "Electronvolt", "eV", 1602176634e-28, 4],
      ["Kilo-electronvolt", "Kilo-electronvolt", "KeV", 1602176634e-25],
      ["Mega-electronvolt", "Mega-electronvolt", "MeV", 1602176634e-22],
      ["Giga-electronvolt", "Giga-electronvolt", "MeV", 1602176634e-19],
      ["Tera-electronvolt", "Tera-electronvolt", "TeV", 1602176634e-16],
      ["British Thermal Unit", "British Thermal Units", "Btu", 1055.06],
      ["Foot-pound", "Foot-pounds", "ft-lb", 1.355818]
    ];
    exports.frequency = [
      ["Hertz", "Hertz", "Hz", 1, 3],
      ["Kilohertz", "kilohertz", "kHz", 1e3],
      ["Megahertz", "Megahertz", "mHz", 1e6],
    ...
    exports.mass = [
      ...
      ["Milligram", "Milligrams", "mg", 1e-3],
      ["Gram", "Grams", "g", 1],
      ["Kilogram", "Kilograms", "Kg", 1e3],
      ["Ton", "Tons", "T", 1e6],
    ...
    exports.degrees = [
      ...
      ["milliradian", "milliradians", "mrad", 180 / Math.PI / 1e3]
    ];
    exports.bytes = [
      ["bit", "bits", "bit", 1 / 8],
      ["byte", "bytes", "B", 1],
      ["Kilobyte", "kilobytes", "KB", 1e3],
      ["Megabyte", "Megabytes", "MB", Math.pow(1e3, 2)],
      ["Gigabyte", "Gigabytes", "GB", Math.pow(1e3, 3)],
      ["terabyte", "Terabytes", "TB", Math.pow(1e3, 4)],
      ["petabyte", "Petabytes", "PB", Math.pow(1e3, 5)],
    ...
    function convertCreator(unitGroup, absoluteValueIndex, convert2, findBest2, stringToAmounts) {
      if (stringToAmounts === void 0) {
        stringToAmounts = dStringToAmounts;
      }
      function converter(from, toOrOptions, maybeOptions) {
        ...
        var to = typeof toOrOptions === "object" ? void 0 : toOrOptions;
        if (typeof from === "number") {
          if (!to)
            return amountToString(unitGroup, findBest2 ? findBest2(unitGroup, [from, absoluteValueIndex], options) : [from, absoluteValueIndex], options);
          var unitIndex = unitIndexByName(unitGroup, to);
          var _a = convert2(unitGroup, [from, absoluteValueIndex], unitIndex), value = _a[0], index = _a[1];
        ...
        if (typeof from === "string") {
          ...
          for (var i = 0; i < arr.length; i++) {
            value += convert2(unitGroup, arr[i], toIndex)[0];
          }
        ...
        if (Array.isArray(from)) {
          ...
          for (var i = 0; i < from.length; i += 2) {
            ...
            if (!(typeof value === "number" || typeof value === "bigint") || typeof unitName !== "string")
              throw new Error("array must be string number pairs and have at least 1 pair");
            result += convert2(unitGroup, [Number(value), unitIndexByName(unitGroup, unitName)], toIndex)[0];
          }
          if (options.stringify)
    ...
    function unitIndexByName(unitGroup, name) {
      ...
      var unitIndex = unitGroup.findIndex(function(item) {
        return item[0].toLowerCase() === name || item[1].toLowerCase() === name || item[2].toLowerCase() === name;
      });
      if (unitIndex === -1)
    ...
    function findBestBytes(_, amount, options) {
      ...
      if (value < options.base)
        return [value, 1];
      var finalUnitIndex = options.base === 1e3 ? 6 : 11;
      var index = options.base === 1e3 ? 2 : 7;
    ...
    function findBest(unitGroup, amount) {
      ...
      for (var i = amount[1]; i >= 0; i--) {
        if (unitGroup[i][4] !== void 0) {
          index = i;
          break;
        }
      }
      if (index === void 0 || unitGroup[index][4] + index < amount[1])
        return amount;
    ...
    var convert = {
      ...
      degrees: convertCreator(exports.degrees, 0, convertBet, void 0, stringToAmountsDegrees),
...
var require_convertSize = __commonJS({
  "node_modules/convert-size/convertSize.js"(exports, module) {
    var convert = require_convert().default;
    module.exports = convert.bytes;
    module.exports.default = convert.bytes;
  }
});
export default require_convertSize();
//# sourceMappingURL=convert-size.js.map
